...
public class Calculator {
	 ...
	 *
	 * @param tokens
	 *            The input string to the program tokenized (split up). Should be a
	 *            String array of two elements: [command, number].
	 ...
	 *             Thrown if the second token is not convertible from String to int.
	 * @throws CalculatorException
	 *             Thrown if the first token is not a valid command ("negate" or
	 *             "halve")
	 */
	 ...
	 * @param tokens
	 *            The input string to the program tokenized (split up). Should be a
	 *            String array of three elements: [num1, command, num2].
	 * @return The result of the calculator operation ("num1 + num2", "num1 - num2",
	 *         or "num1 / num2")
	 * @throws ArithmeticException
	 *             A division by zero has occured.
	 * @throws NumberFormatException
	 *             Thrown if the first or third token is not convertible from String
	 *             to int.
	 * @throws CalculatorException
	 *             Thrown if the second token is not a valid command ("+", "-", or
	 *             "/")
	 */
	 ...
	 *
	 * @param tokens
	 *            The input string to the calculator split into tokens and passed as
	 *            a String array.
	 * @throws ArithmeticException
	 *             A division by zero has occurred.
	 * @throws NumberFormatException
	 *             Thrown if a numeric token is not convertible from String to int.
	 * @throws CalculatorException
	 *             Thrown if the command token is not a valid command ("quit",
	 *             "negate", "halve" "+", "-", "/"). For the 3 tokens case, the
	 *             command token is the second token (e.g. "1 + 3", + is the
	 *             command). For the 2 tokens case, the command token is the first
	 *             token (e.g. "halve 2", halve is the command.
	 */
	 ...
	 *
	 * Valid commands are: "quit" - the program should quit "increment" - an int
	 * should be incremented by 1 "decrement" - an int should be decremented by 1
	 * "+" - two numbers should be added "-" - a number should be subtracted from
	 * another "/" - a number should be divided by another
	 *
	 * @param input
	 *            A String possibly containing a calculator command. Tokens of the
